        ...
        For i = 0 To categorias.Rows.Count - 1
            ...
            If (categorias.Rows(i).Item("nombre") = "Aplicables a Coparticipacion") Then
                ...
                dgv.Rows.Add(
                             ...
                             aplicables(1),
                             aplicables(2),
                             aplicables(0) + aplicables(1) + aplicables(2)
                             )
                totalmes1 = aplicables(0) + totalmes1
                totalmes2 = aplicables(1) + totalmes2
                totalmes3 = aplicables(2) + totalmes3
            Else
...
#Region "Titulos"
        ...
        Sheet.Range("B4").Value = "Egresos UDA Seccional"
